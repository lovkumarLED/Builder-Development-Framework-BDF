...
4. `planning/CLAUDE_CODE_GATE_2_FIXTURE_BUILDER_HANDOFF.md`
5. `planning/CLAUDE_CODE_GATE_2_FIXTURE_BUILDER_REPORT.md`
...
5. `planning/CLAUDE_CODE_GATE_3_PROVIDER_MODEL_REPORT.md`
...
Only after every Stage A command passes, create `planning/CLAUDE_CODE_GATE_3_PROVIDER_MODEL_REPORT.md` from the captured redacted evidence. Do not rerun or reinterpret a failed command as passing. The report is the fifth authorized worker-created file.
...
```powershell
$reportPath="planning/CLAUDE_CODE_GATE_3_PROVIDER_MODEL_REPORT.md"
...
Create `planning/CLAUDE_CODE_GATE_3_PROVIDER_MODEL_REPORT.md` only after verification. It must contain these headings:
