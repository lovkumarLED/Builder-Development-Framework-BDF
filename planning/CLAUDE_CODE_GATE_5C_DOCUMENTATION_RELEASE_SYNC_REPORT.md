...
(`planning/CLAUDE_CODE_SETTINGS_ONLY_SCOPE_CORRECTION_DESIGN.md` §13), Gate 5C
...
- `planning/CLAUDE_CODE_SETTINGS_ONLY_SCOPE_CORRECTION_DESIGN.md`: header
...
- `planning/CLAUDE_CODE_CREDENTIAL_UX_APP_MANAGED_ENV_VARS.md`: lifecycle line.
- `planning/CLAUDE_CODE_README_SCAN_AND_UI_POLISH_DESIGN.md`: lifecycle line.
...
- `planning/CLAUDE_CODE_GATE_5C_DOCUMENTATION_RELEASE_SYNC_REPORT.md` — this
  report.
