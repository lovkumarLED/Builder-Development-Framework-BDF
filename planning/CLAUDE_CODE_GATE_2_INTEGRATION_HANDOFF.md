...
?? planning/CLAUDE_CODE_GATE_2_FIXTURE_BUILDER_HANDOFF.md
...
- Do not copy or overwrite `planning/CLAUDE_CODE_GATE_2_FIXTURE_BUILDER_HANDOFF.md` from any source.
...
- Use the integrated `planning/CLAUDE_CODE_GATE_2_FIXTURE_BUILDER_REPORT.md` as the evidence artifact; it is mapping 9 of 9, not an additional file.
...
The integrated `planning/CLAUDE_CODE_GATE_2_FIXTURE_BUILDER_REPORT.md` remains historical Gate 2 evidence and must not be edited during integration.
