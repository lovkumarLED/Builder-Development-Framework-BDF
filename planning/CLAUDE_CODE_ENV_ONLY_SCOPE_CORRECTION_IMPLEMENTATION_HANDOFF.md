...
Implement
`planning/CLAUDE_CODE_SETTINGS_ONLY_SCOPE_CORRECTION_DESIGN.md` exactly:
...
3. `planning/CLAUDE_CODE_SETTINGS_ONLY_SCOPE_CORRECTION_DESIGN.md`
4. `planning/CLAUDE_CODE_GATE_5B4_DEFAULT_2153_HOSTED_CLI_REPORT.md`
5. `planning/CLAUDE_CODE_FUTURE_CREDENTIAL_UX_FIX.md`
...
- Create exactly
  `planning/CLAUDE_CODE_ENV_ONLY_SCOPE_CORRECTION_IMPLEMENTATION_REPORT.md`.
...
Create
`planning/CLAUDE_CODE_ENV_ONLY_SCOPE_CORRECTION_IMPLEMENTATION_REPORT.md` as
