...
> (`planning/CLAUDE_CODE_ADAPTIVE_SWITCHER_UI_DESIGN.md`) and this handoff. Gate
...
5. `planning/CLAUDE_CODE_ADAPTIVE_SWITCHER_UI_DESIGN.md` (user-approved design;
   this handoff is its executable contract)
6. `planning/CLAUDE_CODE_GATE_1_RESEARCH_REPORT.md`
7. `planning/CLAUDE_CODE_GATE_2_FIXTURE_BUILDER_REPORT.md`
8. `planning/CLAUDE_CODE_GATE_3_PROVIDER_MODEL_REPORT.md`
9. This handoff
...
| # | Path | Purpose |
|---|---|---|
| R1 | `planning/CLAUDE_CODE_GATE_4_APP_INTEGRATION_REPORT.md` | Worker evidence report per section 22 |
...
- `planning/CLAUDE_CODE_ADAPTIVE_SWITCHER_UI_DESIGN.md` (created by the design
...
$gate4bModifiedDocs = $docAllowlist | Where-Object {
  $_ -notlike 'adapters/claude-code/*' -and $_ -notlike 'planning/CLAUDE_CODE_GATE_4_APP_INTEGRATION_REPORT.md'
}
...
Report path: `planning/CLAUDE_CODE_GATE_4_APP_INTEGRATION_REPORT.md`
...
3. **RED/GREEN evidence:** for each task in section 16, the exact RED command,
   ...
   Gate 4A precursor report (`planning/CLAUDE_CODE_GATE_4A_IMPLEMENTATION_REPORT.md`)
...
(`planning/CLAUDE_CODE_GATE_4A_IMPLEMENTATION_REPORT.md`) is an authorized
