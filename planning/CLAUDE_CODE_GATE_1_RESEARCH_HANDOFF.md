...
- Authoritative plan: `planning/CLAUDE_CODE_BDF_ADAPTATION_RESEARCH_PLAN.md`
- Sole authorized output: `planning/CLAUDE_CODE_GATE_1_RESEARCH_REPORT.md`
...
- Changed files: exactly
  `planning/CLAUDE_CODE_GATE_1_RESEARCH_REPORT.md`, or none if stopped before
